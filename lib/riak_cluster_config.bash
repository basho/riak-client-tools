function riak_cluster_config
{
    ...
    then
        ...
        $riak_admin security grant riak_kv.get,riak_kv.get_preflist,riak_kv.put,riak_kv.delete,riak_kv.index,riak_kv.list_keys,riak_kv.list_buckets,riak_kv.mapreduce on any to all
